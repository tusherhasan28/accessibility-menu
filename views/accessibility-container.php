<div id="as-container" class="as-container">
    <div class="as-heading">
        ...
        <div id="as-cross" class="as-heading-cross">
            <img src="<?php esc_html_e( AS_ASSET . '/img/close.png' ); ?>">
        </div>
    </div>
    ...
    <div class="as-button">
        <button style="width: 90%; margin: auto; display: flex; align-items: center; justify-content: center;">
